...
class SystemConfigValidata extends Validate
{
    ...
    protected $rule = [
        ...
        'miniapp_withdraw_start_day' => 'number|between:1,31',
        'miniapp_withdraw_end_day' => 'number|between:1,31',
        'training_camp_c_first_commission' => 'float|egt:0|regex:float_two',
        'training_camp_m_initial_quota' => 'number|egt:0',
        'training_camp_m_first_commission' => 'float|egt:0|regex:float_two',
        'training_camp_d_initial_quota' => 'number|egt:0',
        'training_camp_d_first_commission' => 'float|egt:0|regex:float_two',
        'training_camp_h_initial_quota' => 'number|egt:0',
        'training_camp_h_first_commission' => 'float|egt:0|regex:float_two',
        'training_camp_fallback_commission' => 'float|egt:0|regex:float_two',
        'training_camp_second_commission' => 'float|egt:0|regex:float_two',
    ...
    protected $message = [
        ...
        'miniapp_withdraw_start_day.number' => '提现开放开始日必须为数字',
        'miniapp_withdraw_start_day.between' => '提现开放开始日必须在1-31之间',
        'miniapp_withdraw_end_day.number' => '提现开放结束日必须为数字',
        'miniapp_withdraw_end_day.between' => '提现开放结束日必须在1-31之间',
        'training_camp_c_first_commission.float' => 'C 普通会员一级返佣必须为数字',
        'training_camp_m_initial_quota.number' => 'M 盟友初始名额必须为整数',
        'training_camp_m_first_commission.float' => 'M 盟友一级返佣必须为数字',
        'training_camp_d_initial_quota.number' => 'D 代理初始名额必须为整数',
        'training_camp_d_first_commission.float' => 'D 代理一级返佣必须为数字',
        'training_camp_h_initial_quota.number' => 'H 合伙人初始名额必须为整数',
        'training_camp_h_first_commission.float' => 'H 合伙人一级返佣必须为数字',
        'training_camp_fallback_commission.float' => '名额用完后一级返佣必须为数字',
        'training_camp_second_commission.float' => '二级固定返佣必须为数字',
