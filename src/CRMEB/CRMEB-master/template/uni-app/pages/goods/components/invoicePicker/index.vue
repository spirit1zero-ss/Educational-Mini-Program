<template>
	<view>
		...
		<view class="popup" :class="{ on: invShow }">
							...
							<view class="text">
								...
								<view class="acea-row row-bottom">
									...
									<navigator v-if="!isOrder" class="navigator"
										:url="`?from=order_confirm&id=${item.id}&${urlQuery}`"
										hover-class="none"><text class="iconfont icon-bianji"></text>{{$t(`编辑`)}}
									</navigator>
									<navigator v-else class="navigator"
										:url="`?from=order_details&id=${item.id}&order_id=${orderId}`"
										hover-class="none"><text class="iconfont icon-bianji"></text>{{$t(`编辑`)}}
									</navigator>
								</view>
							</view>
			...
			<view class="popup-ft">
				<navigator v-if="!isOrder" class="navigator"
					:url="`?from=order_confirm&${urlQuery}`" hover-class="none">
					<text class="iconfont icon-fapiao"></text>{{$t(`添加新的抬头`)}}
				</navigator>
				<navigator v-else class="navigator"
					:url="`?order_id=${orderId}&from=order_details&${urlQuery}`"
					hover-class="none">
					<text class="iconfont icon-fapiao"></text>{{$t(`添加新的抬头`)}}
				</navigator>
