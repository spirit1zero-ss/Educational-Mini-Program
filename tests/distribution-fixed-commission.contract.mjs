...
assert.match(distribution, /function cloudStoragePublicUrl/)
assert.match(distribution, /\.tcb\.qcloud\.la/)
assert.match(distribution, /'avatar'\s*=>\s*\$this->cloudStoragePublicUrl/)
