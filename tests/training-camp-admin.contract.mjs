...
assert.match(service, /'is_promoter'\s*=>\s*0/)
assert.match(service, /'spread_open'\s*=>\s*0/)
assert.match(service, /reverseMemberBrokerage/)
assert.match(service, /self_member_brokerage/)
